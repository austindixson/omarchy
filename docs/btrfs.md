...
```bash
sudo omarchy-system-boot-to-esp
# or, before Omarchy is installed:
# curl -LO https://raw.githubusercontent.com/basecamp/omarchy/quattro/bin/omarchy-system-boot-to-esp
...
**before** `install.sh`. The guided path (`omarchy-mac-setup`) runs this for you.
...
```bash
sudo omarchy-system-btrfs-migrate --encrypt   # omit --encrypt to stay unencrypted
# or, before Omarchy is installed:
# curl -LO https://raw.githubusercontent.com/basecamp/omarchy/quattro/bin/omarchy-system-btrfs-migrate
# bash omarchy-system-btrfs-migrate --encrypt
```
